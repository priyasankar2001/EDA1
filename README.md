...
The project includes **15+ publication-quality visualizations** created with Seaborn:

### Distribution Plots
- **Premium Distribution (Histogram + KDE)** - Reveals right-skewed pattern with most premiums concentrated at lower values
- **Age Distribution** - Shows demographic spread of insurance beneficiaries
- **BMI Distribution** - Displays body mass index patterns across the dataset
- **Children Count (Bar Chart)** - Frequency distribution of dependents per beneficiary

### Categorical Analysis
- **Gender Distribution** - Male vs Female beneficiary breakdown
- **Smoker Distribution** - Smoking status prevalence
- **Region Distribution** - Geographic distribution across four US regions

### Outlier Detection
- **Premium Boxplot** - Identifies extreme premium values and potential outliers in insurance costs

### Bivariate Relationships
- **Smoking Impact on Premium (Boxplot)** - Dramatic visualization showing smokers pay 4x more
- **BMI vs Premium (Scatter Plot)** - Relationship between body mass and insurance costs
- **BMI vs Premium by Smoking Status (Color-coded Scatter)** - Shows interaction effect where smoking amplifies BMI impact
- **Age vs Premium (Line Plot)** - Non-linear relationship showing cost increases with age
- **Premium by Gender** - Comparative analysis across genders
- **Premium by Children Count** - Impact of dependents on insurance costs
- **Premium by Region** - Geographic pricing variations

### Advanced Analytics
- **Correlation Heatmap** - Complete correlation matrix showing relationships between all numerical variables
- **Pairplot (Colored by Smoking Status)** - Multi-dimensional visualization showing all pairwise relationships
- **Feature Importance Ranking** - Identifies `smoker` as the strongest predictor of premium

### Grouped Analysis Visualizations
- Average premium comparisons across:
  - Smoking status
  - Geographic regions
  - Gender
  - Number of children

All visualizations use consistent Seaborn theming (`style="ticks", palette="pastel"`) for a professional, cohesive appearance.
